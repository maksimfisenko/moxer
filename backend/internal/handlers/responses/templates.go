...
type Template struct {
	...
	Content   map[string]any `extensions:"x-order=2" validate:"required" json:"content" example:"{\"key\":\"{{variable}}\"}"`
...
type GeneratedData struct {
	Data []map[string]any `validate:"required" json:"data" example:"{\"key\":\"value\"}"`
}
